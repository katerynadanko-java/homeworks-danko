package lesson10.regform.controller;
...
import lesson10.regform.dto.NoteDTO;
import lesson10.regform.service.RegFormService;

@Slf4j
@RestController
@RequestMapping(value = "/api")
public class RegFormController<RegFormService> {
