...
import static lesson05.registrationForm.company.controller.RegexContainer.*;
import static lesson05.registrationForm.company.view.TextConstant.*;
...
public class InputNoteNoteBook {
    ...
    public void inputNote() {
        ...
        String strSurname = (String.valueOf(lesson04.com.company.view.View.bundle.getLocale()).equals("ua"))
                ? REGEX_SURNAME_UKR : REGEX_SURNAME_LAT;

        String strLastName = (String.valueOf(lesson04.com.company.view.View.bundle.getLocale()).equals("ua"))
                ? REGEX_LAST_NAME_UKR : REGEX_LAST_NAME_LAT;
        String strComment = (String.valueOf(lesson04.com.company.view.View.bundle.getLocale()).equals("ua"))
                ? REGEX_COMMENT_UKR : REGEX_COMMENT_LAT;

        String strCity = (String.valueOf(lesson04.com.company.view.View.bundle.getLocale()).equals("ua"))
                ? REGEX_CITY_UKR : REGEX_CITY_LAT;
        String strStreet = (String.valueOf(lesson04.com.company.view.View.bundle.getLocale()).equals("ua"))
